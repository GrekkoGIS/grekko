...
// TODO [$5ecc340c0333270007090fbf]: add concurrency to all of this once benchmarked
...
pub fn get_postcode(coordinates: Vec<f64>) -> Option<String> {
    ...
    // TODO [$5ecc340c0333270007090fc0]: fix this
    redis::cmd("HSCAN")
...
pub fn bulk_set(reader: &mut Reader<File>) {
    ...
    // TODO [$5ecc340c0333270007090fc1]: use rayon to parallelise this
